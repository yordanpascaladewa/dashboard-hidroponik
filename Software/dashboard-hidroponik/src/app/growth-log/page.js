      ...
      <div className="flex-1 flex flex-col min-h-screen w-full lg:w-[calc(100%-260px)]">
        ...
        <main className="flex-1 p-6 md:p-10">
          <header className="mb-8">
            <h1 className="text-3xl font-bold text-[#191c1e] tracking-tight">Growth Log & History</h1>
            <p className="text-base text-[#565e74] mt-2 max-w-2xl">
              Catatan historis pertumbuhan tanaman dan siklus operasional sistem hidroponik.
            </p>
          </header>
