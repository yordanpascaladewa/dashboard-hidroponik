...
export default function DashboardPage() {
  return (
    <>
      {/* Mengimpor Font dan Icon langsung agar desain persis seperti referensi */}
      ...
      {/* MAIN CONTENT AREA SAJA (Tanpa Sidebar / Header luar) */}
      <main className="relative min-h-screen bg-[#121315]">
        <div className="flex flex-col w-full gap-10 p-6 md:p-12 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-end relative z-10 w-full mb-2">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-[48px] font-bold text-[#ffffff] m-0 tracking-[-0.04em] leading-[56px]" style={{ fontFamily: 'Inter, sans-serif' }}>
                  System Overview
                </h1>
              </div>
              <p className="text-[16px] font-medium text-[#e3e2e3] m-0 uppercase tracking-[0.02em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                AeroGrow Pro // Node 04 // Live Telemetry
              </p>
            </div>
            <div className="bg-[#343536] px-5 py-2.5 rounded-full border border-[rgba(255,255,255,0.12)] shadow-md flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-[#00dce5] animate-pulse shadow-[0_0_8px_rgba(0,220,229,0.6)]"></span>
              <span className="text-[12px] font-bold text-[#00dce5] tracking-[0.2em] uppercase" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full relative z-10 mt-2">
            ...
            <div className="lg:col-span-8 bg-[#1f2021] rounded-2xl p-8 border border-[rgba(255,255,255,0.12)] shadow-sm flex flex-col gap-6 relative">
              <div className="flex justify-between items-center w-full border-b border-[rgba(255,255,255,0.12)] pb-4">
                <h2 className="text-[24px] font-semibold text-[#ffffff] m-0 tracking-[-0.02em]" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Tren Kualitas Air <span className="text-[#e3e2e3] font-normal text-[16px] ml-2">(24 Jam Terakhir)</span>
                </h2>
              ...
              <div className="w-full h-[320px] relative mt-4">
                ...
                <div className="absolute bottom-0 left-0 w-full flex justify-between px-2 pt-3 text-[12px] font-bold text-[#e3e2e3]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                  <span>00:00</span>
                  <span>04:00</span>
                  <span>08:00</span>
                  <span>12:00</span>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              <div className="bg-[#1f2021] rounded-2xl p-8 border border-[rgba(255,255,255,0.12)] shadow-sm flex flex-col gap-6 h-full relative overflow-hidden">
                ...
                <h3 className="text-[24px] font-semibold text-[#ffffff] m-0 border-b border-[rgba(255,255,255,0.12)] pb-4 w-full flex items-center justify-between tracking-[-0.02em]" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Hardware Status
                ...
                <div className="flex flex-col gap-5 flex-1 justify-center">
                  ...
                  <div className="flex items-center justify-between p-5 bg-[#292a2b] rounded-xl border border-[rgba(255,255,255,0.12)] z-10">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[28px] font-black text-[#ffffff] tracking-[0.1em] leading-none uppercase" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Selada</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 z-10">
                    <div className="flex flex-col items-center gap-2 p-5 bg-[#292a2b] rounded-xl border border-[rgba(255,255,255,0.12)] text-center">
                      <span className="text-[12px] font-bold text-[#ffffff] uppercase tracking-[0.1em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Tegangan</span>
                      <div className="flex items-baseline gap-1">
                        <span className="text-[28px] font-black text-[#63f7ff]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>12.4</span>
                        <span className="text-[12px] font-bold text-[#63f7ff]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>V</span>
                      </div>
                    </div>
                    <div className="flex flex-col items-center gap-2 p-5 bg-[#292a2b] rounded-xl border border-[rgba(255,255,255,0.12)] text-center">
                      <span className="text-[12px] font-bold text-[#ffffff] uppercase tracking-[0.1em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Arus</span>
                      <div className="flex items-baseline gap-1">
                        <span className="text-[28px] font-black text-[#63f7ff]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>450</span>
          ...
          <div className="w-full bg-[#1f2021] rounded-2xl p-8 border border-[rgba(255,255,255,0.12)] shadow-sm flex flex-col gap-6 relative mt-4 z-10">
            <div className="flex justify-between items-center w-full border-b border-[rgba(255,255,255,0.12)] pb-4">
              <h3 className="text-[24px] font-semibold text-[#ffffff] m-0 flex items-center gap-3 tracking-[-0.02em]" style={{ fontFamily: 'Inter, sans-serif' }}>
                Calibration Hub
                <span className="px-3 py-1 bg-[#343536] rounded-full border border-[rgba(255,255,255,0.12)] text-[12px] font-bold text-[#ffffff] uppercase tracking-[0.1em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                  3 Sensors Online
                </span>
              </h3>
              <button className="px-5 py-2.5 bg-[#10B981] text-[#0d0e0f] text-[12px] rounded-lg hover:bg-[#10B981]/90 transition-colors duration-300 uppercase tracking-[0.1em] font-bold" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                Run Diagnostics
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-5 bg-[#292a2b] rounded-xl border border-[rgba(255,255,255,0.12)] hover:bg-[#343536] transition-colors flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[16px] font-bold text-[#ffffff]" style={{ fontFamily: 'Inter, sans-serif' }}>Sensor Suhu Air</span>
                    <span className="text-[12px] text-[#e3e2e3] font-semibold tracking-[0.1em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Last cal: 14 days ago</span>
                  </div>
                </div>
                <span className="text-[12px] text-[#10B981] font-bold uppercase tracking-[0.1em] px-3 py-1 bg-[#10B981]/10 rounded-full border border-[#10B981]/30" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Akurat</span>
              </div>
              ...
              <div className="p-5 bg-[#292a2b] rounded-xl border border-[rgba(255,180,171,0.3)] hover:bg-[#343536] transition-colors flex items-center justify-between relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 relative z-10">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[16px] font-bold text-[#ffffff]" style={{ fontFamily: 'Inter, sans-serif' }}>Probe pH</span>
                    <span className="text-[12px] text-[#e3e2e3] font-semibold tracking-[0.1em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Last cal: 45 days ago</span>
                  </div>
                </div>
                <span className="text-[12px] text-[#ffb4ab] font-bold uppercase tracking-[0.1em] px-3 py-1 bg-[#ffb4ab]/10 rounded-full border border-[rgba(255,180,171,0.3)] relative z-10" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Perlu Kalibrasi</span>
              </div>
              ...
              <div className="p-5 bg-[#292a2b] rounded-xl border border-[rgba(255,255,255,0.12)] hover:bg-[#343536] transition-colors flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[16px] font-bold text-[#ffffff]" style={{ fontFamily: 'Inter, sans-serif' }}>TDS Meter</span>
                    <span className="text-[12px] text-[#e3e2e3] font-semibold tracking-[0.1em]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Last cal: 5 days ago</span>
                  </div>
                </div>
                <span className="text-[12px] text-[#10B981] font-bold uppercase tracking-[0.1em] px-3 py-1 bg-[#10B981]/10 rounded-full border border-[#10B981]/30" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Akurat</span>
              </div>
