...
export default function DashboardPage() {
  ...
  return (
    <div className="bg-[#121315] min-h-screen text-[#e3e2e3] font-sans overflow-x-hidden">
      ...
      {/* =========================================
          SIDEBAR NAVIGATION (Dengan Animasi Hide)
          ========================================= */}
      <aside 
      ...
      {/* =========================================
          ...
          Otomatis bergeser (ml-72) kalau Sidebar kebuka
          ========================================= */}
      <div 
        className={`transition-all duration-300 ease-in-out flex flex-col min-h-screen ${
          isNavOpen ? 'ml-0 lg:ml-72' : 'ml-0'
        }`}
      >
        
        {/* HEADER BAR (Menempel di atas wrapper) */}
